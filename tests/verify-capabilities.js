...
check('版本六处 10.9', mcp.includes("version: '10.9'") && server.includes("const VERSION = '10.9'") &&
  app.includes("const APP_VERSION = '10.9'") && java.includes('"10.9"') &&
  mani.includes('versionName="10.9"') && vj.includes('"version": "10.9"'));
check('versionCode 89', mani.includes('android:versionCode="89"'));
