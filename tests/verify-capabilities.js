...
check('版本六处 10.3', mcp.includes("version: '10.3'") && server.includes("const VERSION = '10.3'") &&
  app.includes("const APP_VERSION = '10.3'") && java.includes('"10.3"') &&
  mani.includes('versionName="10.3"') && vj.includes('"version": "10.3"'));
check('versionCode 83', mani.includes('android:versionCode="83"'));
