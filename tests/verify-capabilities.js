...
check('版本六处 10.34', mcp.includes("version: '10.34'") && server.includes("const VERSION = '10.34'") &&
  app.includes("const APP_VERSION = '10.34'") && java.includes('"10.34"') &&
  mani.includes('versionName="10.34"') && JSON.parse(vj).version === '10.34');
check('versionCode 114', mani.includes('android:versionCode="114"'));
