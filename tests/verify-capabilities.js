...
check('版本六处 10.20', mcp.includes("version: '10.20'") && server.includes("const VERSION = '10.20'") &&
  app.includes("const APP_VERSION = '10.20'") && java.includes('"10.20"') &&
  mani.includes('versionName="10.20"') && JSON.parse(vj).version === '10.20');
check('versionCode 100', mani.includes('android:versionCode="100"'));
