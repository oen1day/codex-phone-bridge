...
check('版本六处 10.39', mcp.includes("version: '10.39'") && server.includes("const VERSION = '10.39'") &&
  app.includes("const APP_VERSION = '10.39'") && java.includes('"10.39"') &&
  mani.includes('versionName="10.39"') && JSON.parse(vj).version === '10.39');
check('versionCode 119', mani.includes('android:versionCode="119"'));
