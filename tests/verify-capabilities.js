...
check('版本六处 10.42', mcp.includes("version: '10.42'") && server.includes("const VERSION = '10.42'") &&
  app.includes("const APP_VERSION = '10.42'") && java.includes('"10.42"') &&
  mani.includes('versionName="10.42"') && JSON.parse(vj).version === '10.42');
check('versionCode 122', mani.includes('android:versionCode="122"'));
