...
check('版本六处 10.29', mcp.includes("version: '10.29'") && server.includes("const VERSION = '10.29'") &&
  app.includes("const APP_VERSION = '10.29'") && java.includes('"10.29"') &&
  mani.includes('versionName="10.29"') && JSON.parse(vj).version === '10.29');
check('versionCode 109', mani.includes('android:versionCode="109"'));
