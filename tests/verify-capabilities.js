...
check('版本六处 10.5', mcp.includes("version: '10.5'") && server.includes("const VERSION = '10.5'") &&
  app.includes("const APP_VERSION = '10.5'") && java.includes('"10.5"') &&
  mani.includes('versionName="10.5"') && vj.includes('"version": "10.5"'));
check('versionCode 85', mani.includes('android:versionCode="85"'));
