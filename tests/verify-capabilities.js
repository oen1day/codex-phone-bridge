...
check('版本六处 10.58', mcp.includes("version: '10.58'") && server.includes("const VERSION = '10.58'") &&
  app.includes("const APP_VERSION = '10.58'") && java.includes('"10.58"') &&
  mani.includes('versionName="10.58"') && JSON.parse(vj).version === '10.58');
check('versionCode 138', mani.includes('android:versionCode="138"'));
