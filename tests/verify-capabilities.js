...
check('版本六处 10.17', mcp.includes("version: '10.17'") && server.includes("const VERSION = '10.17'") &&
  app.includes("const APP_VERSION = '10.17'") && java.includes('"10.17"') &&
  mani.includes('versionName="10.17"') && JSON.parse(vj).version === '10.17');
check('versionCode 97', mani.includes('android:versionCode="97"'));
