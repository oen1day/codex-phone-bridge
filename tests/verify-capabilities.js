...
check('版本六处 10.4', mcp.includes("version: '10.4'") && server.includes("const VERSION = '10.4'") &&
  app.includes("const APP_VERSION = '10.4'") && java.includes('"10.4"') &&
  mani.includes('versionName="10.4"') && vj.includes('"version": "10.4"'));
check('versionCode 84', mani.includes('android:versionCode="84"'));
