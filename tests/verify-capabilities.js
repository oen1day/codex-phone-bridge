...
check('版本六处 10.35', mcp.includes("version: '10.35'") && server.includes("const VERSION = '10.35'") &&
  app.includes("const APP_VERSION = '10.35'") && java.includes('"10.35"') &&
  mani.includes('versionName="10.35"') && JSON.parse(vj).version === '10.35');
check('versionCode 115', mani.includes('android:versionCode="115"'));
