...
check('版本六处 10.16', mcp.includes("version: '10.16'") && server.includes("const VERSION = '10.16'") &&
  app.includes("const APP_VERSION = '10.16'") && java.includes('"10.16"') &&
  mani.includes('versionName="10.16"') && JSON.parse(vj).version === '10.16');
check('versionCode 96', mani.includes('android:versionCode="96"'));
