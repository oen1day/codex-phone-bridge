...
check('版本六处 10.50', mcp.includes("version: '10.50'") && server.includes("const VERSION = '10.50'") &&
  app.includes("const APP_VERSION = '10.50'") && java.includes('"10.50"') &&
  mani.includes('versionName="10.50"') && JSON.parse(vj).version === '10.50');
check('versionCode 130', mani.includes('android:versionCode="130"'));
