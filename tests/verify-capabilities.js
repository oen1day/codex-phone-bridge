...
check('版本六处 10.36', mcp.includes("version: '10.36'") && server.includes("const VERSION = '10.36'") &&
  app.includes("const APP_VERSION = '10.36'") && java.includes('"10.36"') &&
  mani.includes('versionName="10.36"') && JSON.parse(vj).version === '10.36');
check('versionCode 116', mani.includes('android:versionCode="116"'));
