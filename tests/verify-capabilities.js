...
check('版本六处 10.49', mcp.includes("version: '10.49'") && server.includes("const VERSION = '10.49'") &&
  app.includes("const APP_VERSION = '10.49'") && java.includes('"10.49"') &&
  mani.includes('versionName="10.49"') && JSON.parse(vj).version === '10.49');
check('versionCode 129', mani.includes('android:versionCode="129"'));
