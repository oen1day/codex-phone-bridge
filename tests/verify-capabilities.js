...
check('版本六处 10.59', mcp.includes("version: '10.59'") && server.includes("const VERSION = '10.59'") &&
  app.includes("const APP_VERSION = '10.59'") && java.includes('"10.59"') &&
  mani.includes('versionName="10.59"') && JSON.parse(vj).version === '10.59');
check('versionCode 139', mani.includes('android:versionCode="139"'));
