...
check('版本六处 10.21', mcp.includes("version: '10.21'") && server.includes("const VERSION = '10.21'") &&
  app.includes("const APP_VERSION = '10.21'") && java.includes('"10.21"') &&
  mani.includes('versionName="10.21"') && JSON.parse(vj).version === '10.21');
check('versionCode 101', mani.includes('android:versionCode="101"'));
